...
class Avatar:
    def __init__(self, name, hair, initial_gold):
        self.name = name
        self.hair = hair
        self.gold_bag = initial_gold
        self.gold_buried = 0.0
...
# to the gold that the Avatar is carrying.
    ...
    def find_gold(self, amount):
        self.gold_bag = self.gold_bag + amount
...
# of gold that the Avatar has buried.
    ...
    def bury_gold(self, amount):
        self.gold_bag = self.gold_bag - amount
        self.gold_buried = self.gold_buried - amount
...
# in the Avatar's bag by 10%.
    ...
    def sprinkled_with_fairy_dust(self):
        self.gold_bag = self.gold_bag + (self.gold_bag * 0.1)
...
# of gold carried (in bag) and the amount of gold buried (in the ground).
    ...
    def __str__(self):
        return str(self.name) +" should have " + str(self.gold_bag) + " and " + str(self.gold_buried) + " gold buried" 
...
wildgirl = Avatar("Natacha", "purple", 5.5)
print wildgirl
...
print wildgirl
print "=============================="
madmax = Avatar("Papito", "black", 6.5)
print madmax
